...
void setup() {
  ...
  WiFiManagerParameter custom_station("station", "StationID", station, 8);
  ...
  wifiManager.addParameter(&custom_station);
  ...
  strcpy(station, custom_station.getValue());
