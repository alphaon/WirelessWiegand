...
void setup() {
  ...
  WiFiManagerParameter custom_grant_time("grant_time", "Access Granted", grant_time, 2);
  WiFiManagerParameter custom_deny_time("deny_time", "Access Denied", deny_time, 2);
